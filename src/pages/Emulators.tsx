...
export default function Emulators() {
  return (
    <div className="h-full flex flex-col items-center justify-center p-8 text-center animate-in fade-in duration-300">
      ...
      <h2 className="text-3xl font-bold tracking-tight text-white mb-3">Emuladores</h2>
      <p className="text-gray-400 max-w-md">
        Funcionalidade de emuladores planejada. A fundação de dados já suporta configurações de emuladores para integração futura.
      </p>
    </div>
  );
}
